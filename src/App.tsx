    ...
    <div className={clsx("bg-purple-heart-100 dark:bg-slate-900 transition-colors duration-1000 scroll-smooth",isQuoteVisible && "w-100 h-screen overflow-hidden")}>
        ...
        <div className="w-4/5 flex justify-end items-center">
          ...
          >
            ...
            <li
              ...
              onClick={() => setIsNavOpen(false)}
            >
              <a href="https://drive.google.com/file/d/1mOOPSYB8F6U9OEpbMmzqaMjJ3JnBDc9n/view?usp=sharing" target="_blank">Resume</a>
            </li>
          </ul>

          {/* dark & light hero popup icons */}
          <div className={clsx("absolute left-1/2 h-[200dvh] top-24 -translate-x-1/2 flex flex-col justify-between transition-all duration-1000 dark:rotate-180 pointer-events-none",isSunMoonIconVisible?"opacity-100":"opacity-0")} >
        ...
        <div className="max-w-5xl container">
          <article className="text-lg ">
            ...
            <ul className="list-inside ml-5 inline-flex flex-col flex-wrap max-h-32 gap-1 dark:text-white text-base">
              <li>
                <a href="https://react.dev/" target="_blank" className="inline-flex items-center gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              <li>
                <a href="https://www.typescriptlang.org/" target="_blank" className="inline-flex items-center gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              <li>
                <a href="https://nodejs.org/en" target="_blank" className="inline-flex items-center gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              <li>
                <a href="https://tailwindcss.com/" target="_blank" className="inline-flex items-center gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              <li className="ml-5 sm:ml-20">
                <a href="https://vuejs.org/" target="_blank" className="inline-flex items-center gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
            ...
            <div className="will-change-transform rounded-lg group hover:-translate-y-2 hover:shadow-lg transition-transform duration-500 bg-purple-heart-300 flex flex-col min-h-80 justify-between px-3 py-5">
              ...
              <div className="flex justify-between">
                ...
                <span className="my-auto">
                  {/* github-icon */}
                  <a href="https://github.com/chidam02" target="_blank">
                  ...
                  {/* arrow-icon */}
                  <a href="https://chidam02.github.io/" target="_blank">
      ...
      <section className="relative w-full h-screen flex flex-col justify-center items-center py-20" id="contact">
        <div className="max-w-5xl container text-center mb-10 lg-mb-0">
          ...
          <a href="mailto:chidamanbu@gmail.com" target="_blank">
        ...
        <div className="absolute bottom-5 text-center text-sm text-purple-heart-700">
          <div className="inline-flex gap-3 lg:hidden mb-5">
            ...
            {/* linkedln icon */}
            <div>
            <a href="https://www.linkedin.com/in/chidambaram-t-18a615139/" target="_blank">
            ...
            {/* Phone no */}
            <div>
            <a href="tel:+919444999468" target="_blank">
              <div className="group border-2 border-purple-heart-500 rounded-full inline-flex p-2 gap-2  cursor-pointer flex-row-reverse hover:border-purple-heart-900 dark:hover:border-purple-heart-400">
                  <span>
          ...
          <p className="mt-1">Inspired from <a className="font-bold" href="https://jerome-marshall.github.io/" target="_blank">JM</a></p>
        </div>    
      </section>
